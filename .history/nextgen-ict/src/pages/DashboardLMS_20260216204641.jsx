        ...
        <Box sx={{
          ...
          <Box sx={{ flexGrow: 1, p: { xs: 2, sm: 3 } }}>
            <Routes>
              ...
              <Route path="resources" element={<CoursesPage filter="resources" />} />
              <Route path="online-class" element={<CoursesPage filter="online" />} />
              <Route path="practical" element={<CoursesPage filter="Practical" />} />
            </Routes>
          </Box>
        </Box>
      </Box>
