...
export default function Navbar() {
    ...
    const navlinks = [
        {
            href: "#creations",import { useState } from "react";
import { MenuIcon, XIcon } from "lucide-react";
import { motion } from "framer-motion";
import { Link } from "react-router-dom";
...
export default function Navbar() {
    ...
    // Array eka hariyata coma dala thiyenne
    const navlinks = [
    ...
    return (
        <>
            ...
            <div className={`fixed inset-0 z-[100] bg-black/60 backdrop-blur flex flex-col items-center justify-center text
            text: "Creations",
        },
        {
            href: "#about",
